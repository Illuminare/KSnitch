...
namespace KSnitch.Analysis
{
    ...
    internal sealed class Project
    {
        ...
        public Project(string path, bool readfile = false, string parentprojectpath="")
        {
            ...
            if (!System.IO.Path.IsPathRooted(Path))
            {
                ...
                {
                    Path = System.IO.Path.Combine(System.IO.Path.GetDirectoryName(parentprojectpath), path);
                }
                else
                {
            ...
            if (readfile)
            {
                ...
                foreach (var node in projectNodes)
                {
                    ...
                    var proj = new Project(projpath, readfile, Path);
